<?php 
    ...
    include("../default/admin/doctors_title.php")
?>
    ...
    if($_GET){
        ...
        ';
			...
			$spcil2_res= $database->query("select pname from procedures where id='$prod'");
            $spcil2_array= $spcil2_res->fetch_assoc();
            $spcil2_name=$spcil2_array["pname"];
